...
public class TokenBroadcasterQwen35Tests
{
    ...
    private TokenBroadcasterQwen_3_5 CreateBroadcaster(bool xmlFunctionParsing = false)
        => new TokenBroadcasterQwen_3_5(
    ...
    public void ParseInputForJson_ParsesSingleToolCallWithParameters()
    {
        ...
        var input =
            "<tool_call><function=run_nmap><parameter=target>192.168.1.1</parameter><parameter=scan_options>-sS -T4</parameter></function></tool_call>";
    ...
    public void ParseInputForJson_ParsesMultipleToolCalls()
    {
        var broadcaster = CreateBroadcaster();
        var input =
            "<tool_call><function=function_status_with_message_id><parameter=message_id>Y7_BzX1O13Xi</parameter><parameter=auto_check_interval_seconds>0</parameter></function></tool_call>" +
            "<tool_call><function=function_status_with_message_id><parameter=message_id>TRYsCU2Xre35</parameter><parameter=auto_check_interval_seconds>0</parameter></function></tool_call>";
    ...
    public void ParseInputForJson_ParsesJsonParameterValue()
    {
        var broadcaster = CreateBroadcaster();
        var input =
            "<tool_call><function=run_nmap><parameter=options>{\"ports\":[80,443],\"aggressive\":true}</parameter></function></tool_call>";
    ...
    public void ParseInputForJson_ParsesRawJsonBodyWhenNoParameterTags()
    {
        var broadcaster = CreateBroadcaster();
        var input =
            "<tool_call><function=run_nmap>{\"target\":\"192.168.1.186\",\"scan_options\":\"-sS -T4\"}</function></tool_call>";
