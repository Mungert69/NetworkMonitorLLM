...
public class MonitorToolsBuilder : ToolsBuilderBase
{
    ...
    public override List<ChatMessage> GetSystemPrompt(string currentTime, LLMServiceObj serviceObj, string llmType)
    {
        ...
        content += "The Expert responses must be given in full to the user. It is OK to format the information for human readable form. Make sure to provide all the information and DO NOT summerize. Some of the expers provide reports so it is important to provide this information to the user without altering the content.";
