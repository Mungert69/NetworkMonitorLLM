...
public class LLMProcessRunner : ILLMRunner
{
    ...
    public void SetStartInfo(ProcessStartInfo startInfo, MLParams mlParams)
    {
        ...
        startInfo.Arguments = $"-c 2000 -n 6000 -b 224 -m {mlParams.LlmModelPath + mlParams.LlmModelFileName}  --prompt-cache {mlParams.LlmModelPath + mlParams.LlmContextFileName} --prompt-cache-ro  -f {mlParams.LlmModelPath + mlParams.LlmSystemPrompt}  -ins -r \"<|stop|>\" --keep -1 --temp 0.3 -t {mlParams.LlmThreads}";
